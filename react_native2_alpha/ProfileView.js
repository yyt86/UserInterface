      ...
      <ScrollView style={styles.mainContainer} contentContainerStyle={{ flexGrow: 11, justifyContent: 'center', alignItems: "center" }} keyboardShouldPersistTaps='handled'>
        ...
        <TextInput style={styles.input}
          ...
          // placeholderTextColor="#d9bebd"
            accessible={true}
            accessibilityLabel={"Edit your first Name"}
        ...
        <TextInput style={styles.input}
          ...
          // placeholderTextColor="#d9bebd"
          accessible={true}
            accessibilityLabel={"Edit your last Name"}
        ...
        <TextInput style={styles.input}
          ...
          placeholderTextColor="#d9bebd"
          accessible={true}
            accessibilityLabel={"Edit your daily Calories goal"}
        ...
        <TextInput style={styles.input}
        accessible={true}
            accessibilityLabel={"Edit your daily Protein goal"}
        ...
        <TextInput style={styles.input}
          accessible={true}
            accessibilityLabel={"Edit your daily Carbohydrates goal"}
        ...
        <TextInput style={styles.input}
         accessible={true}
            accessibilityLabel={"Edit your daily fat goal"}
        ...
        <TextInput style={styles.input}
         accessible={true}
            accessibilityLabel={"Edit your daily activity time goal"}
